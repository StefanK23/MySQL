...
SELECT concat(first_name,'.', last_name,'@softuni.bg')  as 'Full email adress' from employees;
...
#Exercise --9-- 
SELECT concat_ws(' ', first_name, middle_name, last_name) as 'Full name' from employees where `salary` = 25000 
or salary = 14000 
or salary = 12500
or salary = 23600;
...
#Exercise --16-- 
CREATE VIEW v_employees_job_titles AS SELECT concat_ws(' ',`first_name`,`middle_name`,`last_name`) as 'Full name', `job_title` 
FROM employees;
...
UPDATE employees SET `salary`= `salary` * 1.12 where `department_id` = 1 or 2 or 4 or 11;
