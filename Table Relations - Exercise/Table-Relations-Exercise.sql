...
salary DECIMAL(10,2),
passport_id INT, 
CONSTRAINT `fk_person_passports` 
...
('Nova', 3);
    ...
    CREATE TABLE `students_exams` (
     ...
     CONSTRAINT fk_students_studentEXAMS FOREIGN KEY (`student_id`) REFERENCES students(`student_id`),
     CONSTRAINT fk_exams_studentEXAMS FOREIGN KEY(`exam_id`) REFERENCES exams(`exam_id`)
     );  
